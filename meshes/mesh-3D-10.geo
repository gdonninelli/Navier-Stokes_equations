...
// --- Mesh Sizes (Livello 10 - COARSE/MEDIUM) ---
// Target: 10 nodi sul diametro D=0.1
// lc_cyl = 0.1 / 10 = 0.01
lc_cyl = 0.01;      
// Fuori dal cilindro celle grandi (10cm) per risparmiare risorse
lc_global = 0.1;    
...
// Box stretto attorno al cilindro e inizio scia
...
// Cylinder (Selezione precisa che evita conflitti coi muri)
