...
// Mesh Sizes (Refined for Level 100 - nodes along diameter)
// Target: 100 nodes along D = 0.1 -> lc_cyl = 0.1 / 100 = 0.001
// Global scaling: lc_global = 10 * lc_cyl = 0.01 (Standard ratio)
lc_cyl = 0.001; 
lc = 0.01;      
